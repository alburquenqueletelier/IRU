        ...
        <div className="container text-center">
            ...
            <div className="col-10 m-auto">
                <p>
                    ...
                    con el tiempo fuimos perfeccionando la preparación 👩‍🍳, y nos dimos cuenta que disfrutamos del proceso 😲.
                    fué entonces cuando se nos ocurrió la idea 💡 de hacer llegar nuestra pasión y amor por los <strong>Cinnamon Rolls</strong> a
                    todas las personas 🌎 amantes de estos deliciosos pasteles 🤤. Así nació <strong style={{ color: "brown" }}>I Roll U - Cinnamon</strong> a fin de expresar
